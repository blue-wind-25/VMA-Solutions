...
public class RefsBox extends JDialog implements ActionListener {
    ...
    private RefsBox(Frame parentFrame)
    {
        ...
        sb.append("Grubbs' Test. Charles Zaiontz. Available from https://www.real-statistics.com/students-t-distribution/identifying-outliers-using-t-distribution/grubbs-test (last accessed August 08, 2021).\n\n");
