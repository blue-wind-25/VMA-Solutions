...
//
// Tab module - ap-rozet panel
//
public class APRozetPanel extends ResultPanel implements Saveable {
    ...
    public boolean drawPlot(Graphics2D g, int w, int h, boolean draft, boolean secondary) throws Exception
    {
        ...
        APRozet apf = new APRozet(anlOWANO, pp, lambda);
    ...
    public String genReport(boolean html, boolean withNonEmptyDoubleLineBreak) throws Exception
    {
        ...
        APRozet apf = new APRozet(anlOWANO, pp, _analysisSP.getLambda());
        ...
        String[] kvps = new String[]{
            "anal_name",   _S("res_anal_ap_rozet"),
            "caption",     mcapt,
            "sub_caption", scapt,
            "C",           "" + anlOWANO.length,
            "lambda",      "" + lambda,
        ...
        return StringTranslator.generateReportFromTemplate("APRozet", kvps, html, withNonEmptyDoubleLineBreak);
    }
