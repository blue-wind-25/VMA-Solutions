...
//
// A toolbox for calculating confidence interval
//
public class CalcCI extends JDialog {
    // Controls
    ...
    // Private constructor
    private CalcCI(Frame parentFrame)
    {
        super(parentFrame);
        ...
        JPanel ipMainPanel = new JPanel(new GridLayout(7, 2, 5, 5), true);
            ...
            JLabel lblCP   = new JLabel(_S("tb_cp_title_ci"));
    ...
    {
        CalcCI rb = new CalcCI(parentFrame);
        GUtil.showModalDialog(rb, null, _S("tb_cp_title_ci"), JRootPane.PLAIN_DIALOG);
    }
}
